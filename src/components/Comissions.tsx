...
import { Paintbrush, Globe, Laptop, DollarSign, Bug } from "lucide-react";
							...
							<CardHeader className="flex flex-col sm:flex-row items-center gap-4">
								...
								<div className="flex-1 sm:ml-8 text-center sm:text-left">
									...
									<motion.div
										...
										whileTap={{ scale: 0.98 }}
										className="flex items-center justify-center sm:justify-end gap-1.5 bg-white/[0.03] w-fit px-2.5 py-1 rounded-md mt-3 mx-auto sm:ml-auto border border-white/[0.03]"
									>
